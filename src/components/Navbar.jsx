...
const Navbar = () => {
  ...
  return (
    ...
    >
      <Toolbar sx={{ minHeight: "48px!important", paddingY: 0, px: 2 }}>
        {/* Logo and Spacer */}
        ...
        {/* Desktop Nav Buttons */}
        {!isMobile && (
          <Box display="flex" gap={2} sx={{ ml: 4 }}> {/* Added margin-left to create space between logo and nav items */}
            {sections.map((sec) => (
              <GradientButton
                key={sec.to}
        ...
        {/* Mobile Menu Icon */}
        {isMobile && (
          <IconButton edge="end" color="inherit" onClick={toggleDrawer(true)} sx={{ ml: "auto" }}>
